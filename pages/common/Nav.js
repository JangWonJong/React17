          ...
          <Box sx={{ flexGrow: 0 }}>
            <Tooltip title="Open settings">
              <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                <Avatar alt="Remy Sharp" src="https://item.kakaocdn.net/do/437998cb670b87a9a8faca156155beebeffd194bae87d73dd00522794070855d" />
              </IconButton>
            </Tooltip>
            <Tooltip title="Open settings">
              <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                <Avatar alt="Remy Sharp" src="https://item.kakaocdn.net/do/437998cb670b87a9a8faca156155beeb15b3f4e3c2033bfd702a321ec6eda72c" />
              </IconButton>
            </Tooltip>
            <Menu
              sx={{ mt: '45px' }}
